...
public class UnionPublisherWrapper {
    ...
    public void addMetaOptionNum(String key, double value) {
        if (mInstance != 0) {
            _set_meta_option_number(mInstance, key, value);
        }
    }

    public void addMetaOptionStr(String key, String value) {
        if (mInstance != 0) {
            _set_meta_option_string(mInstance, key, value);
        }
    }
    ...
    private native void _set_meta_option_number(long ptr, String key, double value);
    private native void _set_meta_option_string(long ptr, String key, String value);
