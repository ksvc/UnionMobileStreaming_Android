...
import org.opencdnunion.media.streamer.filter.imgtex.ImgTexFilterBase;
...
import org.opencdnunion.media.streamer.kit.StreamerConstants;
...
public class BaseCameraActivity extends Activity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mStreamer = new UnionStreamer(this);
    ...
    protected void config() {
        ...
        if (mConfig.mEncodeMethod == StreamerConstants.ENCODE_METHOD_HARDWARE) {
            mStreamer.setVideoEncodeProfile(AVConst.PROFILE_H264_HIGH);
        }
    ...
    private void updateDebugInfo() {
        ...
        mDebugInfo = String.format(Locale.getDefault(), " " +
                        ...
                        "DroppedFrameCount()=%d EncodedFrames()=%d \n " +
                        "UploadedKB()=%d CurrentKBitrate=%d \n " +
                        "Version()=%s",
                encodeMethod, mStreamer.getCurrentPreviewFps(),
                mStreamer.getDroppedFrameCount(), mStreamer.getEncodedFrames(),
                mStreamer.getUploadedKBytes(), mStreamer.getCurrentUploadKBitrate(),
                mStreamer.getVersion());
    }
    ...
    protected void handleEncodeError() {
        ...
        if (encodeMethod == StreamerConstants.ENCODE_METHOD_HARDWARE) {
            ...
            Log.e(TAG, "Got SW encoder error, we have nothing to do...");
        }
    }

    private UnionStreamer.OnInfoListener mOnInfoListener = new UnionStreamer.OnInfoListener() {
        @Override
    ...
    private UnionStreamer.OnErrorListener mOnErrorListener = new UnionStreamer.OnErrorListener() {
        @Override
