package com.union.media.streamer.kit;
...
import com.ksyun.media.streamer.avAdaptor.AVAdapter;
...
import com.ksyun.media.streamer.filter.imgtex.ImgTexToBuf;
...
import com.union.streamer.publisher.librtmp.UnionPublisher;
import com.ksyun.media.streamer.util.BitmapLoader;
import com.ksyun.media.streamer.util.gles.GLRender;
import com.union.media.streamer.encoder.fdkaac.FdkAACEncoder;
import com.union.media.streamer.encoder.x264.X264Encoder;
...
public class UnionStreamer {
    ...
    protected UnionPublisher mRtmpPublisher;
    ...
    protected void initModules() {
        ...
        mRtmpPublisher = new UnionPublisher();
        switchAudioEncoder();
        switchVideoEncoder();
        ...
        mRtmpPublisher.setPubListener(new UnionPublisher.PubListener() {
            @Override
            public void onInfo(int type, long msg) {
                switch (type) {
                    case UnionPublisher.INFO_STARTED:
    ...
    /**
     * Get {@link UnionPublisher} instance which publish encoded a/v frames throw rtmp protocol.
     *
     * @return RtmpPublisher instance.
     */
    public UnionPublisher getRtmpPublisher() {
